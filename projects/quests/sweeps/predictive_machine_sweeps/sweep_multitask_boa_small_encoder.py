...
SWEEP_NAME = "sweep_retrieve_multitask_boa_small_encoder"
NUM_GPUS = 4
HOURS = 12
...
CONFIG_SCRATCH = (
    ...
    "--output-scaling 0.06 --variant xlm --n-layers 4 --n-heads 4 "
    "--learn-positional-embeddings True "
    "--ffn-size 1536 --n-positions 1024 --embedding-size 768 "
