...
SWEEP_NAME = "sweep_retrieve_lightact_multitask_atomic_rand"
HOURS = 12
...
for t in tasks:
    gtask = (
        "light_dialog:simple_multi:light_label_type=action,light.modeling.tasks.atomic.teacher:AtomicTeacher:datatype=train:fill=rand,light.modeling.tasks.quests.goals.teacher:QuestTeacher:stask="
        + t
