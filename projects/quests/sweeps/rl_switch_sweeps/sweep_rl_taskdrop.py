...
# 28794376 sweep_rl_taskdrop
# 28806934 sweep_rl_smalltaskdrop
# 28828087 sweep_rl_moresmalltaskdrop
# 28843212 sweep_rl_revspeakonly
# 28843573 sweep_rl_scalecoef
# 28881236 sweep_rl_speakrevbigact
# 28881406 sweep_rl_bigactscalecoef
# SWEEP_NAME = 'sweep_rl_actvalids'
SWEEP_NAME = "sweep_rl_bigactscalecoef"
...
grid = {
    ...
    "--task_type": ["all"],
    #'--task_type': ['rev'],
    "--num_steps": ["30 --switch_steps 3 --priority false", "100 --priority true"],
