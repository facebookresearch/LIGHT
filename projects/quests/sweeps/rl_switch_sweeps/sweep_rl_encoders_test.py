...
# 28457442
SWEEP_NAME = "sweep_rl_switch_encoders_text_1"
NUM_GPUS = 4
name_keys = {}
...
grid = {
    ...
    #'--switch_steps': [3],
    "--num_steps": [
        "10 --switch_steps 1 --task_type fwd",
        "30 --switch_steps 3 --task_type all",
    ],
    "--enc-type": ["text --num_processes 64", "textcand --num_processes 64"],
    "--hidden_size": [768],
    # '--rewshape': [0.0, 1.0],
    "--valid-loss-coef": [10],
    "--value-loss-coef": [10],
