...
# 28974755
SWEEP_NAME = "sweep_retrieve_rl_encoder_transfer"
HOURS = 24
...
CONFIG_ATOMIC_TRAIN = (
    "light.modeling.tasks.atomic.teacher:AtomicTeacher:datatype=train:fill=bert"
)

CONFIG_ATOMIC_VALID = (
    "light.modeling.tasks.atomic.teacher:AtomicTeacher:datatype=valid:fill=bert"
)
...
grid = {
    ...
    # model args
    "-t": [
        f'"light_dialog:simple_multi:light_label_type=action:light_use_speech=all,{CONFIG_QUEST_HOBBOT_TRAIN},{CONFIG_QUEST_BOA_TRAIN},{CONFIG_ATOMIC_TRAIN}"'
    ],
    "-et": [
        f'"light_dialog:simple_multi:light_label_type=action:light_use_speech=all,{CONFIG_QUEST_HOBBOT_VALID}"'
    ],
    "--multitask_weights": ["1.0,2.0,1.0,1.0"],
    # "--neg-hist-cands": [100],
    # "--neg-hist-negs": [1],
    # "--neg-speaker-negs": [2],
    ...
    "--dict-file": [
        "/checkpoint/rajammanabrolu/20200810/sweep_atomic_retrieve_bert_4codes/_jobid=1/model.dict"
    ],
    "--dict-lower": [True],
    "--dict-tokenizer": ["bpe"],
    "--dropout": [0.00],
    ...
    "--history-size": [20],
    "--init-model": [
        "/checkpoint/rajammanabrolu/20200810/sweep_atomic_retrieve_bert_4codes/_jobid=1/model"
    ],
    "--label-truncate": [100],
