...
SWEEP_NAME = "sweep_retrieve_rl_encoder"
HOURS = 24
...
grid = {
    ...
    "-et": [
        f'"light_dialog:simple_multi:light_label_type=action:light_use_speech=all,{CONFIG_QUEST_HOBBOT_VALID},{CONFIG_QUEST_BOA_VALID}"'
    ],
