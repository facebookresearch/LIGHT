...
SWEEP_NAME = "sweep_retrieve_rl_encoder_poly_small"
HOURS = 24
...
grid = {
    ...
    # model args
    "-t": [
        f'"light_dialog:simple_multi:light_label_type=action:light_use_speech=all,{CONFIG_QUEST_HOBBOT_TRAIN},{CONFIG_QUEST_BOA_TRAIN}"'
    ],
    "-et": [
        f'"light_dialog:simple_multi:light_label_type=action:light_use_speech=all,{CONFIG_QUEST_BOA_VALID}"'
    ],
    "--multitask_weights": ["1.0,1.0,0.5"],
    # "--neg-hist-cands": [100],
    # "--neg-hist-negs": [1],
    # "--neg-speaker-negs": [2],
