...
CONFIG_QUEST_HOBBOT_TRAIN = (
    "light.modeling.tasks.quests.wild_chats.teacher:QuestHobbotTeacher:datatype=train"
)

CONFIG_QUEST_HOBBOT_VALID = (
    "light.modeling.tasks.quests.wild_chats.teacher:QuestHobbotTeacher:datatype=valid"
)

CONFIG_NEG_HIST_TRAIN = "parlai_internal.projects.light.quests.tasks.light_agent_neg_hist.teacher:control_task=light_dialog:neg_hist_cands=100:neg_hist_negs=1:neg_speaker_negs=2:neg_speaker_negs_type=0.5"

CONFIG_NEG_HIST_VALID = "parlai_internal.projects.light.quests.tasks.light_agent_neg_hist.teacher:control_task=light_dialog:neg_hist_cands=20:neg_hist_negs=0:neg_speaker_negs=0"
...
grid = {
    ...
    # model args
    "-t": [
        f'"light_dialog:simple_multi:light_label_type=action:light_use_speech=all,{CONFIG_NEG_HIST_TRAIN},{CONFIG_QUEST_HOBBOT_TRAIN}"'
    ],
    "-et": [
        f'"light_dialog:simple_multi:light_label_type=action:light_use_speech=all,{CONFIG_QUEST_HOBBOT_VALID}"'
    ],
    "--multitask_weights": ["1.0,1.0,2.0"],
    # "--neg-hist-cands": [100],
    # "--neg-hist-negs": [1],
    # "--neg-speaker-negs": [2],
