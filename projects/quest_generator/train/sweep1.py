...
trainy1='fromfile:fromfile_datapath=/checkpoint/light/quest_generator/v1/train.txt'
validy1='fromfile:fromfile_datapath=/checkpoint/light/quest_generator/v1/valid.txt'
trainy2='light_dialog:simple_multi:light_label=speech,internal:light_dialog_wild:simple_multi:light_label=speech'

grid = {
    '-t': [ trainy1, trainy1 + ',' + trainy2 ],
    '-et': [ validy1 ],
    '--max-train-time': [ (60*60)*36 ],
    '--model': [ 'parlai_internal.projects.meena.unlikely.boringul:UnlikelihoodAgent' ],
    '--eval-skip-generation': [ True ],
    ...
    '--init-model': [
        ...
        '/checkpoint/jase/projects/light/beatthehobbot/sw21_ul2_genbig/seq-ul-ratio=0.25_jobid=1/model'
    ],
    '--label-truncate': [128],
...
if __name__ == '__main__':
    run_grid(grid, name_keys, SWEEP_NAME,
             partition='learnfair',
             #partition='dev',
             jobtime='24:00:00',
             ...
             volta=True,
             volta32=True,
             saveroot="/checkpoint/light/quest_generator/models/" + SWEEP_NAME,
             include_job_id=True,
