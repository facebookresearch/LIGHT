...
from parlai_internal.projects.light.lightqa.nq_open.task.agents import (
    find_supporting_sentence,
)
...
from parlai_internal.agents.fid.fid import FiDGoldAgent
...
class StackedKnowledgeDialogueAgent(Agent):
    ...
    def add_cmdline_args(
        ...
        FiDGoldAgent.add_cmdline_args(additional_agent_parser)
        ...
        agent.add_argument(
            ...
            type=str,
            default="/checkpoint/ladolphs/projects/light/lightqa/wow/sweeps/"
        ...
        agent.add_argument(
            ...
            type=str,
            default="/checkpoint/kshuster/projects/wizard_2.0/parlai_sweeps/bart_sweep1_Fri_Oct__2/acf/model",
        ...
        agent.add_argument(
            ...
            type=str,
            default="",
            # /checkpoint/kshuster/projects/wizard_2.0/parlai_sweeps/'
            # 'bart_sweep1_Fri_Oct__2/395/model',
