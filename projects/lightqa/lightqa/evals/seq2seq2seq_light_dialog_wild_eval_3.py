...
"""
Evaluating Seq2Seq2Seq model on light-dialog-wild. Check how the DRM conditioned
on a heuristic confidence score performs.
...
MODELS = {
    ...
    "dialogue_response": [
        ...
        "/checkpoint/ladolphs/projects/light/lightqa/lightqa/sweeps/dialogue_response_sweep_9_Mon_Sep_13_1703/d13/model --add-confidence-as-str false",
        # Trained with {low, medium, high} confidence
        "/checkpoint/ladolphs/projects/light/lightqa/lightqa/sweeps/dialogue_response_sweep_9_Tue_Sep_14_1039/12e/model --add-confidence-as-str true",
    ],
}
