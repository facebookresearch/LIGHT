...
"""
Evaluating Seq2Seq2Seq model on summaryQA.
...
MODELS = {
    "knowledge_response": [
        ...
        "/checkpoint/ladolphs/projects/light/lightqa/lightqa/sweeps/knowledge_response_sweep_6_Mon_Sep_06_1842/d74/model",
        # Trained on LIGHTNC.
        "/checkpoint/ladolphs/projects/light/lightqa/lightqa/sweeps/knowledge_response_sweep_6_Mon_Sep_06_1842/6a5/model",
        # Trained on summaryQA + LIGHTNC.
        "/checkpoint/ladolphs/projects/light/lightqa/lightqa/sweeps/knowledge_response_sweep_6_Mon_Sep_06_1842/f80/model",
    ],
    "dialogue_response": [
        # Trained on lightNC (light-dialog-wild with a noun chunk of the target utterance as knowledge).
        "/checkpoint/ladolphs/projects/light/lightqa/lightqa/sweeps/dialogue_response_sweep_6_Mon_Sep_06_1838/7c0/model",
    ],
}
