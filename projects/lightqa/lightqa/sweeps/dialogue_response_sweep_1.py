...
"""
Train BART model on dialogue response (overlap).
"""
...
grid = {
    ...
    "--model": [
        "bart",
        # 'hugging_face/t5 --t5-model-arch t5-large --dict-tokenizer gpt2'
    ],
    # '--t5-model-parallel': [True],
    # '--t5-dropout': [0],
    "--tensorboard-log": [True],
    ## -------------------------------------------------------
    "--validation-every-n-steps": [250],
    "--batchsize": [4],
    "--fp16": [True],
    "--label-truncate": [512],
    "-lr": [1e-4, 1e-3],
