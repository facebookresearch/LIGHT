...
"""
Train BART model for knowledge response on LightDialogueNounChunk and SummaryQATeacher.

Here, we add self_say_once mutator to make summaryQA and lightdialoguenc look
