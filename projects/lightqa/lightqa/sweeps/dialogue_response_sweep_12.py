...
"""
Train BART model for dialogue response (on LIGHT-NC) and knowledge response.

This model unifies knowledge response and dialogue response into a single BART model.
The knowledge token in the input acts as the control variable.
"""
...
grid = {
    "-t": [
        ...
        "parlai_internal.projects.light.lightqa.lightqa.task.agents:LightDialogueNounChunk:"
        "lightnc-labeltype=knowledge_response:"
        "lightnc-knowledge-provided=None"
    ],
