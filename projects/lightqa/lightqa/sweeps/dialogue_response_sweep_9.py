...
Include a confidence score of the knowledge to the input. The scores ranges
from 0 to 10.

This model can be used as the dialogue response model inside the seq2seq2seq.
"""
...
grid = {
    "-t": [
        ...
        "lightnc-wrong-knowledge-provided=true"
    ],
    "--lightnc-add-empty-knowledge": [True, False],
    "--mutators": ["flatten"],
    "--activation": ["gelu"],
