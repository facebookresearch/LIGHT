...
class TaskDescription extends React.Component {
  render() {
    ...
    let additional_task_description_prefix = task_config.additional_task_description_prefix;
    let additional_task_description_prefix_html = <div dangerouslySetInnerHTML={{ __html: additional_task_description_prefix }} />
    let content = (
      <div>
    ...
    if (!this.props.is_cover_page) {
      ...
      content = (
        <div>
          ...
          <br />
          <br />
          {additional_task_description_prefix_html}
          <br />
          The last message is the answer from &nbsp;<div style={speaker1_style}>Speaker 1</div> on the left and&nbsp;
          <div style={speaker2_style}>Speaker 2</div> on the right&nbsp;.
          <b>Don't base your judgement&nbsp; on their hobbies, job, etc. </b>
          &nbsp; Do your best to ignore the{" "}
