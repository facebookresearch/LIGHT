...
grid = {
    ...
    '--model': [ 'starspace' ],
    '-lr': [ 0.05, 0.1, 0.2 ],
    '--dict-file': ['/private/home/jase/src/ParlAI/parlai_internal/projects/light/light_maps/all.dict'],
...
if __name__ == '__main__':
    run_grid(grid, name_keys, SWEEP_NAME, partition=PARTITION,
             jobtime='40:00:00',
             PARLAI_PATH='/private/home/jase/src/ParlAI/',
             prefix='python -u examples/train_model.py',
             include_job_id=True, create_model_file=True, cpus=40, gpus=0)
