...
light_repo_dir = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
...
for py_filename in python_files:
    ...
    file_contents = file_contents.replace("from light.", "from parlai_fb.projects.light.")
    file_contents = file_contents.replace("import light.", "import parlai_fb.projects.light.")
