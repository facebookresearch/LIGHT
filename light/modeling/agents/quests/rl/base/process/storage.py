...
class RolloutStorage(object):
    def __init__(
        ...
        self.valid = torch.zeros(num_steps, num_processes, action_space)
        self.action_probs = torch.zeros(num_steps, num_processes, action_space)
    ...
    def insert(
        ...
        self.valid[self.step].copy_(valid)
        self.action_probs[self.step].copy_(action_probs)
