...
class EnvironmentWrapper(object):
    def __init__(self, opt):
        ...
        RLAgent_opt = {
            ...
            'override': {
                'model': 'parlai_internal.projects.light.quests.tasks.rl_base.agents.rl_agent:RLAgent',
                'person_tokens': True,
        ...
        EnvAgent_opt = {
            ...
            "override": {
                "model": "from light.modeling.agents.quests.rl.base.agents.env_agents:LightRetrievalAgent",
                "person_tokens": True,
                "eval_candidates": "fixed",
                "encode_candidate_vecs": True,
                "fixed_candidates_path": opt["speech_fixed_candidate_file"],
