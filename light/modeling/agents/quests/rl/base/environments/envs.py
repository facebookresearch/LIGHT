...
from light.modeling.agents.quests.rl.base.agents.env_agents import LightRetrievalAgent

# TODO find and expose these models?
RL_MODEL_FILES = {
    "action": {
        10: os.path.join(
...
class EnvironmentWrapper(object):
    def __init__(self, opt):
        ...
        RLAgent_opt = {
            ...
            "model": "light.modeling.agents.quests.rl.base.agents.rl_agent:RLAgent",
            "person_tokens": True,
        ...
        # replicated above
        RLRetrieval_opt = {
            "model": "light.modeling.agents.quests.rl.base.agents.env_agents:LightRetrievalAgent",
            "person_tokens": True,
            "eval_candidates": "fixed",
            "encode_candidate_vecs": True,
            "fixed_candidates_path": opt["speech_fixed_candidate_file"],
        ...
        RLGeneration_opt = {
            "model": "light.modeling.agents.quests.rl.base.agents.env_agents:LightGeneratorAgent",
            "person_tokens": True,
            "eval_candidates": "fixed",
            "encode_candidate_vecs": True,
            "fixed_candidates_path": opt["speech_fixed_candidate_file"],
