...
class QuestCreator():
    ...
    templates = {
        'obtain': ["I want OBJECT.", "I need OBJECT.", "I'm looking for OBJECT.", "I'd really like OBJECT.", "I must get OBJECT, urgently."],
        'give': ["I need to get OBJECT to AGENT.", "I want to give OBJECT to AGENT.", "I must get OBJECT to AGENT as soon as possible.",
                 "I really need to give OBJECT to AGENT."],
        'drop': ["I need OBJECT in LOCATION as soon as possible.", "I'd like to get OBJECT in LOCATION."],
        ...
        'hit': ["I want to make AGENT pay for what they've done.", "I want to get my revenge on AGENT."],
        'steal': ["I'd like to get OBJECT from AGENT.", "AGENT has OBJECT, and I want it."],
        'put': ["I need to put OBJECT IN CONTAINER.", "I want to get OBJECT IN CONTAINER."]
        }
    ...
    def pick_location(actor, graph, verb, arg, obj=None):
        ...
        for i in range(0, 100): 
            ...
            loc = graph.rooms[loc]
            viable_target = True
            if loc is not None and loc.container_node.get() == actor.container_node.get():
                viable_target = False
            if viable_target:
                return loc
        # Failed.
