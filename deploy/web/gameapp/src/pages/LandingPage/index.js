...
const LandingPage = (props)=>{
    ...
    <div className="landingpage-container">
        <h1 style={{fontWeight:"bold", color:"white"}}>Welcome to the world of LIGHT</h1>

        <div className="instructions-container">
            <div className="instructions-container__half">
                {page === 0 ?
                <div className="instruction-bubble">
                    <p>The Dungeon Master is glad to see you.</p>
                </div>
                : null
                }
                {page === 1 ?
                <div className="instruction-bubble">
                    <h2 style={{color:"gold"}}>Roleplay your Character</h2>
                    <p>
