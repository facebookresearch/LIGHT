                ...
                <div className="instructions-container__section">
                    <div className="instruction-bubble">
                        <div className="guide-container">
                            <img className="guide-img" src={Scribe}/>
                                <div className="arrowbox">
                                    {
                                    page !== 0 ?
                                    <div onClick={()=>pageChangeHandler("-")} className="instruction-arrow__container">
                        ...
                        <div className="instruction-text__container">
                            {page == 0 ?
                            <>
                                <p style={{fontSize:"2.5em", textAlign:"center"}}>The Dungeon Master is glad to see you.</p>
                            </>
                            : null
                            }
                            {page == 1 ?
                            <>
                                <h2 style={{color:"gold", textAlign:"center"}}>Roleplay your Character</h2>
                                <p>
                            ...
                            {page == 2 ?
                            <>
                                <h2 style={{color:"gold", textAlign:"center"}}>Interact with the World</h2>
                                <p>
