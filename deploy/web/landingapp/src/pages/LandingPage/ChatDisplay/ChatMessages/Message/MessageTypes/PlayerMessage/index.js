...
const PlayerMessage = ({ text, action }) => {
  return (
    <div className={`_player-message-row_  flex w-full mb-4`}>
        ...
        <div className="w-full flex flex-row justify-end items-center">
          {action === "say" ? (
            <div className="_quote-container_ relative w-[1px] h-full">
              <RiSingleQuotesL
                size={38}
                className="_quote-icon-stroke_ absolute text-accent -left-[18px] -top-[18px] z-38"
              />
              <RiSingleQuotesL
                size={30}
              ...
              <RiSingleQuotesL
                size={38}
                className="_quote-icon-stroke_ absolute text-accent -left-[8px] -top-[18px] z-38"
              />
              <RiSingleQuotesL
                size={30}
            ...
            <ChatBubble action={action} actor="YOU" align="right">
              <div className="w-full flex flex-row justify-between items-between ">
                <div className="flex flex-col w-[90%]">
                  <p
                    className={`_player-message-bubble-text_ w-full min-w-[40px]  break-words text-left text-md ${
