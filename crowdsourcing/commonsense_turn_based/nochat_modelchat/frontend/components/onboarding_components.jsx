...
function OnboardingUtterance({ 
    ...
    return (
        <div className={`alert ${turnIdx % 2 == 0 ? "alert-info" : "alert-warning"}`} style={{ float: `${turnIdx % 2 == 0 ? "right" : "left"}`, display: 'table' }}>
            <span className="onboarding-text"><b>{turnIdx % 2 == 0 ? 'YOU' : 'GAME ENGINE'}:</b> {text}
                <ErrorBoundary>
                    {extraElements}
                </ErrorBoundary>
            </span>
        ...
        return (
            <div id="onboarding-main-pane">
                <OnboardingDirections>
                    ...
                    <div>
                        To first learn about the labeling task, please evaluate the "GAME ENGINE" speaker in the conversation below, choosing the correct checkboxes.
                    </div>
                    <h4 style={{textAlign:"left"}}>
                    <br></br>
                    <b>Label Key: </b> Narrations can be multiple of the following.<br></br>
                    <i>Doesn't follow from setting described (excluding last action)</i>: The narration conflicts with the state of the world (e.g. makes up characters and objects).
                    <br></br> <br></br> 
                    <i>Doesn't follow from last action</i>: The narration doesn't make sense as the result of the provided action.
                    <br></br> <br></br>
                    <i>Grammatical/Spelling issues</i>: The narration contains typos or other grammatical/spelling issues
                    <br></br> <br></br>
                    <i>None, all good</i>: The narration is consistent with the world and the provided action.
                    </h4>
                    <br></br>
                    <h4 style={{textAlign:"left"}}>
                    <br></br>
                    <b>Game Context</b><br></br>
                    You are in the hut in the hills.<br></br>
                    This is the only hut left in the whole wasteland. The castle stands at a distance.<br></br>
                    There's a whetstone.<br></br>
                    You check yourself. You are the knight!<br></br>
                    The sad peasant is here.<br></br>
                    You are carrying an axe, wearing an old armor, and wielding a sword.
                    </h4>
