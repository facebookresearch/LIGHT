    ...
    <CustomOnboardingChatApp
      ...
      renderSidePane={({ mephistoContext: { taskConfig, initialTaskData }, appContext: { taskContext } }) => {
        ...
        if (task_data !== undefined) {
          ...
          bold_current_player = "<br><br><h3> You are: <b>" + task_data.current_player + "</b>. <br><br> Given the <b>action</b> by " + task_data.actor + ", rate the response as if the game provided it as an observation to your character.</h3>";
