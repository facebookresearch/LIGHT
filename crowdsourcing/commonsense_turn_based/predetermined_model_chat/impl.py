...
def run_task(cfg: DictConfig, task_directory: str, world_module=None):
    ...
    """
    only_allow = cfg.use_allowlist
    world_log_path = cfg.world_log_path
    ...
    dialogs = []
    with jsonlines.open(world_log_path, "r") as f:
        for line in f:
            dialogs.append(line)
    ...
    for item in dialogs:
        ...
        teacher_dialog['world_log_path'] = world_log_path
    ...
    for t in task_data:
        ...
        new_task_data[-1]['source_fname'] = world_log_path
