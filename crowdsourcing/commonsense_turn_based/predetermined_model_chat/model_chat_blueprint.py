...
from typing import Any, Dict, List, Optional, TYPE_CHECKING, Iterable
import types
import numpy as np
import torch
import yaml
...
class BaseModelChatBlueprint(ParlAIChatBlueprint, ABC):
    ...
    def __init__(
        ...
        if shared_state.static_task_data is not None:
        ...
        shared_state.world_opt.update(
            {
                'block_qualification': args.blueprint.get("block_qualification"),
                ...
                'this_config': shared_state.static_task_data
            }
        )
