...
//BasicEditRoom - Basic room editor available in sidebar of MapPage that allows user to create new rooms and place characters and objects in those rooms
const BasicEditRoom = ({
    saveFunction,
    addContent,
    addRoom,
    ...
    //3.  Add isLoading state and spinner with overlay for async API interactions.x
    ...
    const handleAdvancedClick = ()=>{
        //saves changes before navigating away
        saveFunction()
        let updatedLocation = {
            name:"rooms",
            id: formattedRoomId
    ...
    //GENERATE HANDLERS
    //Generates Characters and Objects for Selected Room
    ...
    //     const result = await getRoomAttributes({target_room, room_graph}).then((result) => {
        ...
        <div className="basiceditroom-container">
            ...
            <div className="basiceditroom-button">
                ...
                }
                {
                    ...
                    <TextButton
                        text={"DELETE"}
                        clickFunction={RoomDeleteHandler}
                    />
                    :
                    null
                }
