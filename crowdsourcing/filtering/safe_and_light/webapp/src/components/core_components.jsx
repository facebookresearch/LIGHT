...
function DescInstructions() {
  return (
    <div>
      <b>Safety:</b> Each sentence can be marked as either SAFE or UNSAFE. Things that are SAFE 
      ...
      <br/>
      <b>Medieval Fantasy:</b> Each sentence can be marked as either FANTASY or REAL. Things that are FANTASY 
