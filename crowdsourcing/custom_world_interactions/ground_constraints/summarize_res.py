...
bad_users = set()
with open('/private/home/alexgurung/LIGHT/crowdsourcing/custom_world_interactions/collect_narrations/users_who_didnt_get_it.txt', 'r') as f:
   d = f.read()
   bad_users.update(d.split("\n"))

with open('/private/home/alexgurung/LIGHT/crowdsourcing/custom_world_interactions/ground_events/users_who_didnt_get_it.txt', 'r') as f:
   d = f.read()
   bad_users.update(d.split("\n"))

with open('/private/home/alexgurung/LIGHT/crowdsourcing/custom_world_interactions/ground_attributes/users_who_didnt_get_it.txt', 'r') as f:
   d = f.read()
   bad_users.update(d.split("\n"))
