...
ALLOWLIST_QUAL_NAME = "OBJINTERACTION_DATA_ANNOTATION_TASK_ALLOWLIST"
...
def main(cfg: DictConfig) -> None:
    ...
    direct_soft_block_mturk_workers(
        db,
        get_block_list('/private/home/alexgurung/LIGHT/crowdsourcing/custom_world_interactions/jing_allow_workers.txt'),
        ALLOWLIST_QUAL_NAME,
        cfg.mephisto.provider.requester_name,
    )
    direct_soft_block_mturk_workers(
        db,
        get_block_list('/private/home/alexgurung/LIGHT/crowdsourcing/custom_world_interactions/collect_narrations/found_workers.txt'),
        ALLOWLIST_QUAL_NAME,
        cfg.mephisto.provider.requester_name,
    )
