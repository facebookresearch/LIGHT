...
const Copy ={
    ...
    interaction: {
        ...
        tutorialCopy: [
            ...
            },
            {
                ...
                explanation:'Select the item that is the one that the actor is using most in the interaction. Usually, this would be an item the actor can hold or utilize for the interaction. If both are held and used equally, select "either".',
                screenshot: EventShot1
            },
        ]
    },
    narration: {
        ...
        questions: {
            ...
            1: "4. Provide a rephrasing of the narration, removing external context if it is present.",
            2: "5. Update the provided narration for a third-party observer, removing context an observer wouldn't know.",
        },
        tutorialCopy: [
            {
    ...
    objects: {
        ...
        questions: {
            0: "6. Ensure the list of objects that remain in the location of the action is consistent with the interaction. Update the list if it is not.",
            1: "7. Correct the descriptions for the remaining objects to be consistent with the interaction, but clear via observation",
            2: "8. Ensure the provided final object locations are correct. Options are 'in/on <another object>', 'in room', 'held/worn/wielded by actor'",
        },
        tutorialCopy: [
            {
            ...
            },
            {
                ...
                explanation: 'Ensure the provided final object locations are correct. Options are "in/on <another object>", "in room", "held/worn/wielded by actor". If the final location is somewhere far away, the object should instead be removed from the list in question 6.',
                screenshot: EventShot1
            },
        ]
    },
    attributes: {
        ...
        questions: {
            0: "9. What properties for the objects are required beforehand? Are they removed by the interaction? Provide explanations",
            1: "10. What properties are introduced as a result of the interaction between these objects?",
        },
        tutorialCopy: [
            {
                question:"9) What properties for the objects are required beforehand? Are they removed?",
                explanation:'You should assess if the provided properties are required by the interaction. For instance, if a blade is being used to cut a rope, it should be "sharp", but it doesn\'t need to be "metal" unless the narration points that out. Your answers should start with "required because" or "not required because". You can extend the list if necessary with comma separated attributes in the "EXTRAS" entry, should there be additional requirements for an object given the narration.',
                screenshot: EventShot1
            },
            {
