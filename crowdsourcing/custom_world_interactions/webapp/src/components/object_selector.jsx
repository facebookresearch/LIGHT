...
function ObjectSelector({ primaryObjectList, secondaryObjectList, onChangeCurrentPrimaryObject, onChangeCurrentSecondaryObject, otherActive, onChangeOtherActive }) {
  return (
    <div className="menu">
      <Form.Group controlId="exampleForm.ControlSelect1">
        <Form.Label>Primary Object: </Form.Label>
        <br />
        <SingleSelector objectList={primaryObjectList} onChangeCurrentSelectedObject={onChangeCurrentPrimaryObject} />
        <br />
        <br />
        <Form.Label>Secondary Object: </Form.Label>
        <br />
        <SingleSelector objectList={secondaryObjectList} onChangeCurrentSelectedObject={onChangeCurrentSecondaryObject} />
        <br />
        <Button variant="primary" onClick={() => { otherActive ? onChangeOtherActive(false) : onChangeOtherActive(true)}}>Other</Button>
        <br />
        { otherActive ? <OtherSecondaryForm onChangeCurrentSecondaryObject={onChangeCurrentSecondaryObject}/> : null }
        <br />
      </Form.Group>
    </div>
  )
